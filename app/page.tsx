    ...
    <>
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .manifesto { background: linear-gradient(180deg, rgba(255,184,0,0.02), transparent); }
        ...
        .howx-step { flex: 1 1 0; min-width: 0; border: 1px solid rgba(255,255,255,0.12); border-radius: 16px; padding: clamp(18px, 3vw, 24px) clamp(12px, 2vw, 16px); background: rgba(255,255,255,0.02); text-align: center; display: flex; flex-direction: column; align-items: center; }
        ...
        .box { text-align: center; padding: clamp(16px, 3vw, 20px); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; background: rgba(255,255,255,0.02); }
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <form onSubmit={handleModalSubmit}>
              <input type="email" value={modalForm.email} onChange={(e) => setModalForm({ ...modalForm, email: e.target.value })} placeholder="you@company.com" required style={{ marginBottom: '12px' }} />
              <div className="seg">
                <input type="radio" id="modal-company" name="modalAudience" value="company" checked={modalForm.audience === 'company'} onChange={(e) => setModalForm({ ...modalForm, audience: e.target.value })} />
                <label htmlFor="modal-company">Company</label>
                <input type="radio" id="modal-app" name="modalAudience" value="app" checked={modalForm.audience === 'app'} onChange={(e) => setModalForm({ ...modalForm, audience: e.target.value })} />
                <label htmlFor="modal-app">Individual</label>
              </div>
              {modalForm.audience === 'company' && (
                <input type="text" value={modalForm.organization} onChange={(e) => setModalForm({ ...modalForm, organization: e.target.value })} placeholder="Company (optional)" style={{ marginBottom: '12px' }} />
              )}
              <button type="submit" className="btn primary prominent" style={{ width: '100%', minHeight: '52px' }}>Start Building Free</button>
              <div className={`status ${modalStatus.show ? 'show' : ''} ${modalStatus.type}`}>{modalStatus.message}</div>
            </form>
            <p style={{ marginTop: '12px', fontSize: '0.85rem', color: '#9fa8bf' }}>{spotsLeft} spots left · No card required</p>
          </div>
        </div>
      </div>
      ...
      <header className="hero container" id="top">
        <div className="hero__wrap">
          ...
          <h1 className="grad hero__title">AI deployment without the giant's blessing</h1>
          <p className="hero__subtitle">Decentralized AI inference powered by idle smartphones. Verified at the edge.</p>
          <p className="hero__tagline">No credit card gatekeeping. No surprise bills. No GPU waitlists. Just proof-verified compute that costs 70% less.</p>
          <div className="cta">
        ...
        <div className="container">
          ...
          <div className="killer-grid">
            <div className="killer-card">
              ...
              <div className="killer-text">Just to experiment. Before you have validated anything.</div>
            </div>
            <div className="killer-card">
              <div className="killer-icon">⏳</div>
            ...
            <div className="killer-card">
              ...
              <div className="killer-text">Unverified startups do not get the good stuff.</div>
            </div>
            <div className="killer-card">
              <div className="killer-icon">🔒</div>
          ...
          <p className="killer-cta">There is a better way →</p>
        </div>
      </section>

      {/* Democratize AI Manifesto */}
          ...
          <div className="manifesto-wrap">
            ...
            <div className="manifesto-grid">
              ...
              <div className="manifesto-item">
                ...
                <p>Not what AWS thinks you will use. Not what your quota allows. Actual inference tokens processed.</p>
              </div>
              <div className="manifesto-item">
          ...
          <div className="promoX-card">
            <div className="promoX-wrap">
              <div className="promoX-copy">
                ...
                <h2 className="promoX-title grad">First <span>100 builders</span> get paid to try SlyOS.</h2>
                ...
                <ul className="promoX-badges">
                  <li><svg viewBox="0 0 16 16"><path d="M6.4 10.6 3.8 8l-.9.9 3.5 3.5L13 5.8l-.9-.9z"/></svg>Proof-verified results</li>
                  <li><svg viewBox="0 0 16 16"><path d="M8 1l6 3v4c0 4-2.6 6.7-6 7C4.6 14.7 2 12 2 8V4z"/></svg>Private pools available</li>
                  <li><svg viewBox="0 0 16 16"><path d="M2 8h4l1 3 2-6 1 3h4"/></svg>Edge-first latency</li>
                </ul>
              </div>
              <div className="promoX-meter">
                ...
                <p style={{ color: '#9fa8bf', fontSize: '0.8rem', margin: 0 }}>Private beta · Q1 2025</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="demo-steps">
            ...
            <div className="demo-step">
              <div className="demo-content">
                ...
                <h3>Select & Deploy</h3>
                <p>Choose which models to deploy. Set your redundancy level. Configure device policies. Hit deploy. That is it.</p>
              </div>
              <div className="demo-image">
      ...
      <section id="metrics" className="section">
        <div className="container">
          ...
          <div className="rule"></div>
          <div className="grid4">
            <div className="ptile"><div className="num">70%</div><div className="lbl">lower cost vs GPU cloud</div></div>
            <div className="ptile"><div className="num">60%</div><div className="lbl">faster first-token at edge</div></div>
            <div className="ptile"><div className="num">15x</div><div className="lbl">redundant validations</div></div>
            <div className="ptile"><div className="num">100%</div><div className="lbl">jobs get signed receipts</div></div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', padding: 'clamp(20px, 4vw, 28px)', margin: '1.5rem 0' }} className="card">
              <div className="grad" style={{ fontSize: 'clamp(2.5rem, 6vw, 3.5rem)', fontWeight: 800, lineHeight: 1, marginBottom: '0.4em' }}>up to 69%</div>
              <div style={{ color: '#cfd6e6', fontSize: 'clamp(0.95rem, 1.5vw, 1.1rem)' }}>Savings vs AWS & GCP</div>
            </div>
            <div className="totals">
              <div className="box" id="slyBox"><div className="num">$400</div><div className="lbl">SlyOS (20M tokens)</div></div>
              <div className="box"><div className="num">$1,200</div><div className="lbl">AWS (20M tokens)</div></div>
              <div className="box"><div className="num">$1,400</div><div className="lbl">GCP (20M tokens)</div></div>
            </div>
            <p style={{ textAlign: 'center', color: '#9fa8bf', fontSize: '0.9rem', marginTop: '1rem' }}>Pay per inference. No minimums. No surprises.</p>
          </div>
        </div>
      </section>
      ...
      <section id="mine" className="section">
        <div className="container">
          ...
          <div className="rule"></div>
          <div className="mgrid">
            <div className="mcard"><h3 className="grad">Earn credits</h3><p>Validated workloads turn into SLY usage credits that offset your future jobs.</p></div>
            <div className="mcard"><h3 className="grad">Green impact</h3><p>Tap idle phones instead of spinning new servers. Less stranded capacity.</p></div>
            <div className="mcard"><h3 className="grad">Transparent by design</h3><p>Per-task receipts: job type, duration, replication %, anomalies, timings.</p></div>
            <div className="mcard"><h3 className="grad">Idle-first, capped</h3><p>Opportunistic background tasks with device caps to avoid interference.</p></div>
          </div>
        </div>
      </section>
      ...
      <section id="compare" className="section">
        <div className="container">
          ...
          <div className="tablecmp">
            <table>
              <thead>
                <tr><th></th><th>Acurast</th><th>Enurochain</th><th className="grad">SlyOS</th></tr>
              </thead>
              <tbody>
                <tr><td>Built-in validation</td><td>~</td><td>✕</td><td>✔</td></tr>
                <tr><td>AI-optimized inference</td><td>✕</td><td>~</td><td>✔</td></tr>
                <tr><td>Edge-first latency</td><td>~</td><td>✕</td><td>✔</td></tr>
                <tr><td>Cryptographic receipts</td><td>✕</td><td>✕</td><td>✔</td></tr>
                <tr><td>Private compute pools</td><td>✕</td><td>✕</td><td>✔</td></tr>
                <tr><td>Cost structure</td><td><span className="badge">Variable</span></td><td><span className="badge">Token-based</span></td><td><span className="badge">Up to 70% lower*</span></td></tr>
              </tbody>
            </table>
          </div>
          <p style={{ color: '#9fa8bf', fontSize: '0.9rem' }}>*Illustrative savings shown in Pricing section compared to traditional cloud providers.</p>
        </div>
      </section>
      ...
      <section id="faqs" className="section">
        <div className="container">
          ...
          <div className="rule"></div>
          <div className="faq">
            <details><summary>Is this crypto or blockchain-based?</summary><p>No. SLY are platform usage credits—not cryptocurrency or tokens. There is no blockchain, no mining rewards, and no speculative trading. Think of SLY credits like AWS credits: they are simply accounting units for compute time on our platform.</p></details>
            <details><summary>What types of AI workloads can I run?</summary><p>Currently optimized for embeddings, lightweight inference (up to 7B parameter models), and bursty evaluation tasks. We are expanding to support larger models through device-class routing, where higher-spec smartphones handle more demanding workloads. RAG pipelines, semantic search, and classification tasks work particularly well.</p></details>
            <details><summary>How do I trust the results from random smartphones?</summary><p>Every job gets cryptographic receipts that include: redundancy percentage (typically 15x validation), consensus details showing which devices agreed, anomaly detection results, and precise timing data. You can verify that multiple independent devices produced identical outputs, making tampering mathematically impractical.</p></details>
            <details><summary>Can I restrict where my jobs run?</summary><p>Absolutely. You can create private pools with your own devices, use vetted contributor pools with KYC'd participants, set geographic restrictions (e.g., "EU devices only"), require minimum device specifications, or combine these policies. Enterprise customers get granular control over device selection.</p></details>
            <details><summary>What about SLAs and reliability?</summary><p>We measure validated completion time, not just raw device speed. Our SLA guarantees are based on successfully validated outputs. If redundancy fails or consensus is not reached, you do not pay. Typical jobs complete within 2-5 seconds for inference, with sub-second p95 latency for edge-local requests.</p></details>
            <details><summary>How does pricing compare to AWS/GCP/Azure?</summary><p>For supported workloads, you will typically see 60-70% cost reduction compared to cloud GPU instances. Pricing is transparent: you pay per million tokens processed, with volume discounts automatically applied. No hidden fees, no egress charges.</p></details>
            <details><summary>What happens to my data privacy?</summary><p>Jobs can be end-to-end encrypted. Input data is sharded before distribution—no single device sees your complete dataset. Models run in secure enclaves where available. For maximum privacy, use private pools where you control all devices. We never log or store your inference inputs or outputs.</p></details>
            <details><summary>How do contributors earn SLY credits?</summary><p>Device owners earn credits proportional to validated compute time. Earnings depend on device specs, uptime, and validation success rate. High-performing contributors get priority routing. You can cash out credits or use them to offset your own inference costs.</p></details>
            <details><summary>What is the onboarding process?</summary><p>Join our waitlist above. We are onboarding in phases: first companies with immediate inference needs, then individual developers, and finally contributor device owners. Beta participants get 1,000 free SLY credits. Typical onboarding takes 2-3 days including API key setup and initial testing.</p></details>
            <details><summary>Which models and frameworks do you support?</summary><p>We support ONNX, TensorFlow Lite, and PyTorch Mobile formats. Popular models include Sentence Transformers (embeddings), DistilBERT, MobileBERT, BERT-small, and quantized versions of Llama, Mistral, and Phi. If you have a specific model, reach out—we are rapidly expanding compatibility.</p></details>
          </div>
        </div>
      </section>
      ...
      <section id="waitlist" className="section">
        <div className="container">
          ...
          <div className="card" style={{ maxWidth: '560px', margin: '0 auto', textAlign: 'center' }}>
            <p style={{ marginBottom: '16px', fontSize: '1.1rem', color: '#c8cfdd' }}>Onboarding in phases. Add your email for early access.</p>
            <form onSubmit={handlePageSubmit}>
              <input type="email" value={pageForm.email} onChange={(e) => setPageForm({ ...pageForm, email: e.target.value })} placeholder="you@company.com" required />
              <div className="seg">
                <input type="radio" id="page-company" name="pageAudience" value="company" checked={pageForm.audience === 'company'} onChange={(e) => setPageForm({ ...pageForm, audience: e.target.value })} />
                <label htmlFor="page-company">Company</label>
                <input type="radio" id="page-app" name="pageAudience" value="app" checked={pageForm.audience === 'app'} onChange={(e) => setPageForm({ ...pageForm, audience: e.target.value })} />
                <label htmlFor="page-app">Individual</label>
              </div>
              {pageForm.audience === 'company' && (
                <input type="text" value={pageForm.organization} onChange={(e) => setPageForm({ ...pageForm, organization: e.target.value })} placeholder="Company (optional)" />
              )}
              <div style={{ marginTop: '16px' }}>
                <button type="submit" className="btn primary prominent" style={{ width: '100%' }}>Join waitlist</button>
              </div>
              <div className={`status ${pageStatus.show ? 'show' : ''} ${pageStatus.type}`}>{pageStatus.message}</div>
            </form>
            <p style={{ marginTop: '12px', fontSize: '0.85rem', color: '#9fa8bf', lineHeight: 1.5 }}>We store your email, audience type, and (if provided) company to manage access invites.</p>
          </div>
        </div>
      </section>
